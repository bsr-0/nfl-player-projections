    ...
    def load_weekly_data(self, seasons: List[int], 
        ...
        for season in seasons:
            ...
            if not df.empty:
                ...
                has_empty_opp = (
                    'opponent' not in df.columns
                    or df['opponent'].eq('').any()
                    or df['opponent'].isna().any()
                )
                    ...
                    try:
                        ...
                        if sched_df is not None and not sched_df.empty:
                            ...
                            if sched_rows:
                                ...
                                # schedule and player_weekly_stats both use the canonical
                                # JAX/LA codes (see entity_resolver.TEAM_CODE_ALIASES) — no
